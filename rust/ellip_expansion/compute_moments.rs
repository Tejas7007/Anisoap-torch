// Derived from cersonsky-lab/AniSOAP under Apache-2.0.
// Modified to add batched pair-level moment evaluation.
...
pub fn compute_moments_batch_rust(
    ...
    let results: Vec<Vec<f64>> = (0..n_pairs)
        .into_par_iter()
        .map(|pair| {
                ...
                for deg in 2..md {
                    for n0 in 0..=deg {
                        for n1 in 0..=(deg - n0) {
                            ...
                            let x_iter_add = if n0 > 0 {
                                cov00 * n0 as f64 * moments[idx(n0 - 1, n1, n2)]
                            } else {
                                0.0
                            } + if n1 > 0 {
                                cov01 * n1 as f64 * moments[idx(n0, n1 - 1, n2)]
                            } else {
                                0.0
                            } + if n2 > 0 {
                                cov02 * n2 as f64 * moments[idx(n0, n1, n2 - 1)]
                            } else {
                                0.0
                            };
                            ...
                            if n0 == 0 {
                                let y_iter_add = if n1 > 0 {
                                    cov11 * n1 as f64 * moments[idx(0, n1 - 1, n2)]
                                } else {
                                    0.0
                                } + if n2 > 0 {
                                    cov12 * n2 as f64 * moments[idx(0, n1, n2 - 1)]
                                } else {
                                    0.0
                                };
                                ...
                                if n1 == 0 {
                                    moments[idx(0, 0, n2 + 1)] = a2 * mom_cur
                                        + if n2 > 0 {
                                            cov22 * n2 as f64 * moments[idx(0, 0, n2 - 1)]
                                        } else {
                                            0.0
                                        };
                                }
